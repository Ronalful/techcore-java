...
import com.example.module11.author.CreateAuthorDto;
import com.example.module11.book.BookDto;
import com.example.module11.book.CreateBookDto;
import com.example.module11.jwt.JwtTokenProvider;
import com.example.module11.notification.NotificationClient;
import com.example.module11.user.Role;
import com.example.module11.user.User;
import com.example.module11.user.UserRepository;
...
public class Module11ApplicationTestsWithTestContainers {
    ...
    void testCreateBook() {
        ...
        Mockito.doNothing().when(notificationClient).sendNotification();
